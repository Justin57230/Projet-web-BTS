            ...
            <?php foreach ($postsAbonnements as $post) : ?>
                ...
                <div class="post">
                    ...
                    <div class="post-header post-info">
                        <a href="profil2.php?id=<?php echo $post['utilisateur_id']; ?>"><img src="<?php echo $infoUtilisateur['photo_profil']; ?>" alt="Photo de Profil de <?php echo $infoUtilisateur['pseudo']; ?>" class="post-picture"></a>
                        <div class="post-owner-info">
                            <a href="profil2.php?id=<?php echo $post['utilisateur_id']; ?>" class="pseudo"><?php echo $infoUtilisateur['pseudo']; ?></a>
                        </div>
                    </div>
