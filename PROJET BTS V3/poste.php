...
<head>
    ...
    <link rel="stylesheet" href="votre_stylesheet.css"> <!-- Ajoutez le lien vers votre feuille de style CSS ici -->
</head>
<body>
    ...
    <form class="post-form" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
        ...
        <input type="file" name="media" class="post-media" accept="image/*,video/*"><br>
